...
        st.plotly_chart(pie1, use_container_width=True, config={'displayModeBar': False}) # Added config for pie chart
with col_chart2:
...
        line.update_layout(height=550, legend=dict(title_text='', orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis_tickformat=',', paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        bar1.update_layout(height=550, xaxis_tickangle=0, bargap=0.5, showlegend=False, yaxis_tickformat=',', paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(bar1, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
with col_chart4:
...
        st.plotly_chart(pie2, use_container_width=True, config={'displayModeBar': False}) # Added config for pie chart
with col_chart5:
...
        st.plotly_chart(pie3, use_container_width=True, config={'displayModeBar': False}) # Added config for pie chart
...
        st.plotly_chart(pie_expense_h1, use_container_width=True, config={'displayModeBar': False}) # Added config for pie chart
with col_h_exp2:
...
        line_expense_h2.update_layout(height=550, legend=dict(title_text='', orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis_tickformat=',', paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_expense_h2, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        st.plotly_chart(pie_expense_d1, use_container_width=True, config={'displayModeBar': False}) # Added config for pie chart
with col_d_exp2:
...
        line_expense_d2.update_layout(height=550, legend=dict(title_text='', orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis_tickformat=',', paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_expense_d2, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        line_total_profit_rate.update_layout(height=550, legend=dict(title_text="", orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis=dict(ticksuffix="%", tickformat=",.2f"), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_total_profit_rate, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        line_hall_profit_rate.update_layout(height=550, legend=dict(title_text="", orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis=dict(ticksuffix="%"), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_hall_profit_rate, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        line_delivery_profit_rate.update_layout(height=550, legend=dict(title_text="", orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis=dict(ticksuffix="%"), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_delivery_profit_rate, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        fig_bep.update_traces(selector=dict(type='bar'), texttemplate='%{text:,.0f}원', textangle=0, hovertemplate="<b>월:</b> %{x}<br><b>%{data.name}:</b> %{y:,.0f}원<extra></extra>") # Updated texttemplate
        fig_bep.update_traces(selector=dict(type='scatter'), texttemplate='%{text:,.0f}원', hovertemplate="<b>월:</b> %{x}<br><b>%{data.name}:</b> %{y:,.0f}원<extra></extra>") # Updated texttemplate
        fig_bep.update_layout(barmode='group', height=550, legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="center", x=0.5), yaxis=dict(tickformat=","), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(fig_bep, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        line_food_cost.update_layout(height=550, legend=dict(title_text="", orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis=dict(ticksuffix="%"), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_food_cost, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
...
        line_labor_cost.update_layout(height=550, legend=dict(title_text="", orientation="h", yanchor="bottom", y=1.15, xanchor="center", x=0.5), yaxis=dict(ticksuffix="%"), paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', dragmode='pan') # Added dragmode
        st.plotly_chart(line_labor_cost, use_container_width=True, config={'scrollZoom': False, 'displayModeBar': True, 'modeBarButtonsToRemove': ['zoom2d', 'zoomIn2d', 'zoomOut2d', 'autoscale', 'select2d', 'lasso2d']}) # Updated config
